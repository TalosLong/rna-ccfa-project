...
| Learned refinement generalizes across datasets. | external77 GT_CON candidate membership, all three 42/42 source conditions, and the 126-record normalized matrix are frozen and validated. | NOT_TESTED | The independent test is ready as an evaluation resource; no learned model has been fitted or evaluated. |
