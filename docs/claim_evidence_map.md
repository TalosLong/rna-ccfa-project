...
| Claim B: cross-model agreement provides transferable correction evidence. | Prediction-only Legacy121 audit: correct fraction rises from 0.1587 to 0.3686 to 0.9764 for 0/1/2 other-model supports, monotonically for all three sources. | PROMISING_HYPOTHESIS | v2.0.1 is protocol-complete and ready for Legacy121 training, but training has not started; no trained cross-model refiner or independent evidence exists. |
