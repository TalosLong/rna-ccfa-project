...
| Learned refinement generalizes across datasets. | No independent normalized refiner test set is currently ready. | NOT_TESTED | The 42-sequence nonredundant external77 GT_CON subset is only a candidate until its target manifest and complete three-source predictions are frozen. |
