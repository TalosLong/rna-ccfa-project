...
| Learned evidence reconciliation improves FP removal at high TP preservation. | ERN event/RNA FP removal was 0.475531/0.660806, but event TP preservation was 0.989682 and failed the frozen 0.99 condition. Gate B failed. | **NOT SUPPORTED UNDER FROZEN SAFETY GATE** | No rescue tuning and no automatic R5 progression. |
| Evidence can improve non-evidenced pairs without excessive collateral TP loss. | ERN NON_EVIDENCED removal was useful but lost a mean 2,687.8 TP; scope TP preservation was 0.988801. Evidence improved ERN over B4 but reduced overall preservation. | **MIXED / SAFETY REQUIREMENT FAILED** | Do not claim safe propagation or start noisy/real-evidence work automatically. |
